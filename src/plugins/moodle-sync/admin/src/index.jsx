...
// Use a simple SVG instead of the problematic @strapi/icons import
const PluginIcon = () => (
...
export default {
  register(app) {
    app.addMenuLink({
      to: '/plugins/moodle-sync',
      icon: PluginIcon,
      intlLabel: {
        id: 'moodle-sync.plugin.name',
        defaultMessage: 'Moodle Sync',
      },
      Component: async () => {
